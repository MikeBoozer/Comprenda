"""
Comprenda — Cultural Intelligence Platform
Main entry / home dashboard (the morning read).

Streamlit-in-Snowflake app. Run via Snowflake → Projects → Streamlit.
Redesign blueprint: Claude-Code-Handoff.md §6.1.
"""
import datetime
...
from lib.comprenda_components import (
    sidebar_brand, page_header, kpi, badge, pill, band_of,
)

st.set_page_config(page_title="Comprenda — Cultural Intelligence", layout="wide")
inject_css()
sidebar_brand()
